      ...
      <div className="w-full max-w-4xl text-2xl">
        {pages.map((page, i) => (
          <div className="flex items-center justify-between" key={i}>
            <span className="w-1/5">{page.day < 10 ? `0${page.day}` : page.day} </span>
            <Link className="group w-3/5" href={`/day${page.day}`}>
            ...
            <a
              className="group flex w-1/5 items-center gap-1 px-3 py-1 hover:bg-black hover:text-white"
              target="_blank"
              href={page.sodt.url}
            >
              {page.sodt.name}
